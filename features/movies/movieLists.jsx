    ...
    <>
      ...
      {isLoading ? (
        ...
        <div className="flex items-center justify-center">
            <div className="bg-neutral-500 p-4 m-2 rounded-[10px] cursor-pointer">
                1
            </div>
            <div className="bg-neutral-500 p-4 rounded-[10px] cursor-pointer" onClick={()=> navigate('/movieLists2')}>
                2
            </div>
        </div>
        </div>
